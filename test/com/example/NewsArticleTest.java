...
public class NewsArticleTest {
    public static final String JSON_FOR_ONE_ARTICLE = "{\n" +
    ...
    public static final String JSON_FOR_ARRAY_OF_ARTICLES = "[{\n" +
            "    \"author\": \"Kelsey Snell, Kelsey Snell\",\n" +
            "    \"title\": \"Senate approves bill doubling hurricane aid package, extending federal borrowing limit\",\n" +
            "    \"description\": \"The bill heads to the House for final approval as leaders rush to approve FEMA money before emergency funds run out.\",\n" +
            "    \"url\": \"https://www.washingtonpost.com/powerpost/mcconnell-introduces-bill-linking-hurricane-aid-package-federal-borrowing-limit/2017/09/07/2c0cf1d6-9382-11e7-8754-d478688d23b4_story.html\",\n" +
    ...
    private static NewsArticle [] newsArticleArray;

    private static ArrayList<NewsArticle> newsArticles;
    ...
    public void setUp() throws Exception {
        ...
        newsArticleArray = gson.fromJson(JSON_FOR_ARRAY_OF_ARTICLES, NewsArticle[].class);

        newsArticles = new ArrayList<NewsArticle>();
        for (int i = 0; i < newsArticleArray.length; i++) {
            newsArticles.add(newsArticleArray[i]);
        }
    ...
    public void getAuthor() throws Exception {
        assertEquals("Kelsey Snell, Kelsey Snell", newsArticle.getAuthor());
    }

    @Test
    public void getTitle() throws Exception {
        assertEquals("Senate approves bill doubling hurricane aid package, extending federal borrowing limit",
                newsArticle.getTitle());
    }

    @Test
    public void getDescription() throws Exception {
        assertEquals("One of the people familiar described it as a “gentlemen’s agreement.”",
                newsArticleArray[1].getDescription());
    }
